...
" Highlighting strings longer than 128 characters
syn match apdlStringLineErr display "'.*'"ms=s+129,me=e-1 contained
syn match apdlStringLine display "'.*'" contains=apdlStringLineErr
...
syn match	apdlRepeat	display "\*endif\>" contained
...
syn match	apdlComment	"\/com.*$" contains=apdlTodo
...
if version >= 508 || !exists("did_apdl_syntax_inits")
 ...
 HiLink apdlFunction Statement
 HiLink apdlLabel	Label

 HiLink apdlError	Error
 HiLink	apdlStringLineErr Error
